...
\titulo{Control Inteligente de Volúmen para Sistema de Anuncios de Audio en Material Rodante} 
...
El presente proyecto pretende solucionar un problema que ocasiona quejas frecuentes por parte de los pasajeros de 
distintas líneas de tren en la Argentina: la dificultad de escuchar correctamente los 
...
en esa parte del trayecto. Sin embargo, aumentar
demasiado el volúmen puede producir una sensación de aturdimiento, especialmente en tramos donde
hay un nivel de ruido ambiente menor. Una solución para este desafío es la implementación de un
control inteligente de volúmen. 

El control inteligente de volúmen es algo que ya existe en el mercado 
(ver \href{http://www.ervocom.ch/en/module/solutions/10-digital-audio-solution-for-passenger-announcements}
{Passenger announcement for rolling stock}), sin embargo lo que se pretende es una solución a medida
para las formaciones locales de origen chino. Se intentará conectar el prototipo a la red TCN de 
material rodante para que el maquinista pueda ajustar distintos parámetros de ser necesario. 
